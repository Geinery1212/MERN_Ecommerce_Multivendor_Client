...
import imageProduct from '../../assets/images/products/1.webp'
const WishList = () => {
    return (
        <div className='w-full grid grid-cols-4 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6'>
            {
                [1, 2, 3, 4, 5, 6].map((p, i) => <div key={i} className='border group transition-all duration-500 hover:shadow-md hover:-mt-3 bg-white'>
                    <div className='relative overflow-hidden'>
                        ...
                        <img className='sm:w-full w-full h-[240px]' src={imageProduct} alt="" />
