                        ...
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            <div className='py-2'>
                                <h2 className='text-3xl font-bold mb-3 text-slate-600'>Category</h2>
                                {
                                    categories.map((element, index) => {
                                        return <div className='flex justify-start items-center gap-2 py-1'>
                                            <input type="checkbox" id={element} />
                                            <label htmlFor={element} className='text-slate-600 block cursor-pointer'>{element}</label>
                                        </div>
                                    })
                                }
                            </div>
                            ...
                            <div className='py-2 flex flex-col gap-5'>
                                ...
                                <Range
                                    ...
                                    renderThumb={({ props }) => (
                                        <div className='w-[15px] h-[15px] bg-[#059473] rounded-full' {...props}></div>
                                    )}
                                />
...
cursor-pointer'>
    ...
    cursor-pointer rounded-sm`}>
                                ...
                                <div>
                                    <Pagination pageNumber={pageNumber} setPageNumber={setPageNumber} totalItems={10} perPage={perPage} showItem={Math.floor(10 / 3)} />
                                </div>
                            </div>
                        </div>
                    </div>
